...
- **PSGallery**: ✅ Опубликован (v2.13, 18.01.2026; v2.14 готов к публикации)
...
```powershell
$script:Version = "2.14"           # Единый источник версии
...
3. **test** - Pester тесты (115 тестов, запускается после lint и syntax)
...
- `tests/Helpers.Tests.ps1` - 59 unit-тестов, `tests/Fixes.Tests.ps1` - 56 тестов
...
```powershell
Invoke-Pester ./tests -Output Detailed              # 115 Pester тестов
