...
3. **test** - Pester тесты (268, запускается после lint и syntax; интеграционные требуют admin - на GitHub runners это выполняется)
...
Invoke-Pester ./tests -Output Detailed              # 268 Pester теста (84+127+57)
